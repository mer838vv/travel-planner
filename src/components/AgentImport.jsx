    ...
    <div className="card agent-import">
      <div>
        ...
        <p className="agent-hint">
          Попроси Claude собрать поездку — он найдёт перелёт, жильё, места и погоду,
          и выдаст готовый план. Скопируй его ответ и вставь сюда: маршрут по дням,
          билеты, список вещей и бюджет заполнятся сами.
        </p>
      </div>
